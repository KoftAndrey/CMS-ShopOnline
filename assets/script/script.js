...
const modalId = document.querySelector('.modal__id_content_value');
const modalForm = document.querySelector('.modal__form');
const modalCheckboxButton = document.querySelector('.form__checkbox');
const modalCheckboxInput = document.querySelector('[name="discont"]');
...
const checkModalTotalPrice = form => {
  ...
  form.count.addEventListener('input', () => {
    setTimeout(setModalTotalPrice, 400);
  });
